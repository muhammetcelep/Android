...
public class golsayfasi extends AppCompatActivity {
    public MediaPlayer mediaPlayer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        mediaPlayer=MediaPlayer.create(golsayfasi.this,R.raw.lake);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_golsayfasi);
        ...
        zamanlayici.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(golsayfasi.this);
