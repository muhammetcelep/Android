...
public class semsiyesayfasi extends AppCompatActivity {
    public MediaPlayer mediaPlayer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        mediaPlayer=MediaPlayer.create(semsiyesayfasi.this,R.raw.semsiyeyagmur);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_semsiyesayfasi);
        ...
        zamanlayici.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(semsiyesayfasi.this);
