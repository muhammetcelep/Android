...
public class saganakyagmursayfasi extends AppCompatActivity {
    public MediaPlayer mediaPlayer;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        mediaPlayer=MediaPlayer.create(saganakyagmursayfasi.this,R.raw.saganakyagmur);
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_saganakyagmursayfasi);
        ...
        zamanlayici.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(saganakyagmursayfasi.this);
