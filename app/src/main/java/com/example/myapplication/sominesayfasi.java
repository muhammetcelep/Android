...
public class sominesayfasi extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sominesayfasi);
        mediaPlayer=MediaPlayer.create(sominesayfasi.this,R.raw.somine);
        ...
        zamanlayici.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder builder=new AlertDialog.Builder(sominesayfasi.this);
